...
Many learned TE systems achieve low online latency but assume a complete
...
matrix. On a 1{,}584-satellite Starlink constellation with $2\%$--$50\%$
observability, \sysname{} achieves a mean maximum link utilization (MLU)
of $1.64$--$1.89$ with sub-$0.4$-s decisions. Comparisons with imputation-based
and temporal controls do not establish a statistically significant overall
advantage. Ablations show a $6.7\%$ mean MLU reduction from training at
$50\%$ observability, while gains remain dependent on the observation ratio.
\end{abstract}
