...
On a 1{,}584-satellite Starlink constellation, treating the training
initialization as an experimental factor rather than noise, we find that MLU
rankings vary with both the observation ratio and the initialization.
...
the full distribution over training initializations rather than only a
column-wise summary statistic.
