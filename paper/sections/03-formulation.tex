...
ratios after an optional repair step (\cref{sec:training}): ADMM
...
already conservation-feasible by \eqref{eq:conserve} but may still
...
marginal-contribution reward (\cref{sec:design}) --- followed by an
optional lightweight repair step at inference that relieves overloaded
links (\cref{sec:training}). This paradigm makes the observation
